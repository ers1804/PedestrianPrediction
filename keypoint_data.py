...
import dataclasses
import enum
from typing import Collection, Dict, Iterable, List, Mapping, Optional, Union
...
class KeypointsTensors:
  ...
  has_visible: Optional[tf.Tensor] = None
...
def create_pose_estimation_tensors(
    poses: Iterable[Union[PoseLabel, PosePrediction]],
    default_location: np.ndarray,
    order: Collection['KeypointType'],
    dtype: tf.DType = tf.float32,
