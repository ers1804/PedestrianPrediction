...
flags.DEFINE_string("dataset", "waymo_alphapose_weakly_supervised", "Dataset to train on. NOTE: Weakly-supervised datasets directly imply the learning paradigm.")
flags.DEFINE_string('config', 'configs/config.gin', 'Config file that should be loaded.')
