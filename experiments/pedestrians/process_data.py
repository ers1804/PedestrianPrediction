...
def main():
    ...
    for desired_source in ["eth", "hotel", "univ", "zara1", "zara2"]:
        for data_class in ["train", "val", "test"]:
            env = Environment(
                node_type_list=["PEDESTRIAN"], standardization=standardization, dt=dt
            )
            ...
            data_dict_path = os.path.join(
                "../processed", "_".join([desired_source, data_class]) + ".pkl"
            )
            ...
            for subdir, dirs, files in os.walk(
                ...
                for file in files:
                    if file.endswith(".txt"):
                        ...
                        for node_id in tqdm(
                            pd.unique(data["node_id"]), desc="Processing Nodes"
                        ):
                        ...
                        if data_class == "train":
                            ...
                            for angle in tqdm(angles, desc="Rotations"):
